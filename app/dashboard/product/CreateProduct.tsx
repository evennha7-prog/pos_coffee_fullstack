      ...
      <DialogContent className="w-[95vw] sm:w-full max-w-[560px] max-h-[92vh] overflow-y-auto p-4 sm:p-6 rounded-2xl">
        <DialogHeader>
          ...
          <DialogDescription className="text-xs sm:text-sm text-muted-foreground">
            Add a new item with image, SKU code, price, and stock levels to your POS menu.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 py-2">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            <div className="space-y-1">
              <Label htmlFor="product-code" className="text-xs sm:text-sm font-medium">
                SKU / Code{" "}
                <span className="text-[11px] text-muted-foreground font-normal">(Auto if empty)</span>
              </Label>
              <Input
                id="product-code"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <div className="space-y-1">
              <Label htmlFor="product-cost" className="text-xs sm:text-sm font-medium">
                Cost / Strikethrough ($)
              </Label>
              <Input
                id="product-cost"
            ...
            {/* Selling Price Field */}
            <div className="space-y-1">
              <Label htmlFor="product-price" className="text-xs sm:text-sm font-medium">
            ...
            {/* Stock Field */}
            <div className="space-y-1">
              <Label htmlFor="product-stock" className="text-xs sm:text-sm font-medium">
          ...
          {/* Note / Description */}
          <div className="space-y-1">
            <Label htmlFor="product-note" className="text-xs sm:text-sm font-medium">
              Note / Description
            </Label>
            <Input
              id="product-note"
