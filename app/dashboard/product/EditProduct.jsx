...
export default function EditProduct({ isOpen, onOpenChange, product, onSave }) {
    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Update this product's name, category, price, or stock levels.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 py-2">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            {/* Stock Field */}
            <div className="space-y-1">
              <Label htmlFor="edit-product-stock" className="text-sm font-medium">
