    ...
    <div className="flex flex-1 flex-col gap-6 p-4 md:p-6 bg-slate-50/50 dark:bg-background">
      <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-foreground">Damaged & Lost Items</h1>
            <p className="text-sm text-muted-foreground">Log of items discarded due to damage, spillage, theft, or warehouse loss</p>
          </div>
        </div>
      </div>
      ...
      <Card className="border bg-card shadow-2xs">
        <CardHeader className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <CardTitle className="text-base font-semibold">Damage & Loss Log</CardTitle>
            <CardDescription>Track wastage to calculate net raw material costs and operational shrinkage</CardDescription>
          </div>
