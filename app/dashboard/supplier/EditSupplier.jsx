...
export default function EditSupplier({ isOpen, onOpenChange, supplier, onSave }) {
    ...
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Update vendor details, contact info, and notes.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 py-2">
          ...
          <div className="space-y-1">
            <Label htmlFor="edit-supplier-company" className="text-sm font-medium">
          ...
          <div className="space-y-1">
            <Label htmlFor="edit-supplier-contact" className="text-sm font-medium">
          ...
          {/* Phone Field */}
          <div className="space-y-1">
            <Label htmlFor="edit-supplier-phone" className="text-sm font-medium">
          ...
          {/* Address Field */}
          <div className="space-y-1">
            <Label htmlFor="edit-supplier-address" className="text-sm font-medium">
          ...
          {/* Note Field */}
          <div className="space-y-1">
            <Label htmlFor="edit-supplier-note" className="text-sm font-medium">
